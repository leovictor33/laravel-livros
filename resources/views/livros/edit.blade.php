...
@section('content')
    ...
    <form action="{{ route('livros.update', $livro->codigo) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="str_titulo" name="str_titulo" class="form-control"
                   value="{{ old('str_titulo', $livro->str_titulo) }}" required>
            @error('str_titulo')
        ...
        <div class="mb-3">
            ...
            <input type="text" name="str_editora" id="str_editora" class="form-control"
                   value="{{ old('str_editora', $livro->str_editora) }}" required>
            @error('str_editora')
            <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="num_edicao" id="num_edicao" class="form-control"
                   value="{{ old('num_edicao', $livro->num_edicao) }}" required>
            @error('num_edicao')
            <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="num_valor" name="num_valor"
                   value="{{ old('num_valor', $livro->num_valor ?? '') }}" required>
        </div>
